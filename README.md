...
This dataset can be downloaded at the link: [https://doi.org/10.6084/m9.figshare.31044040.v2](https://doi.org/10.6084/m9.figshare.31044040.v2). Following the data sharing policy of X/Twitter, this dataset does not contain full tweets but contains tweet ID and annotations.
